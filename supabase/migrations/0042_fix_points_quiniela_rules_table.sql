-- 0042: Fix calculate_prediction_points_for_quiniela_v3
-- The previous version queried "quinielas" table for exact_score_points which doesn't exist there.
-- The correct table is "quiniela_rules".

-- Drop ALL old signatures to start clean
...
-- Re-create recalculate function
